package expo.modules.nativeliquidtabs.kyant.components
...
import expo.modules.nativeliquidtabs.kyant.utils.DampedDragAnimation
...
fun LiquidBottomTabs(
    ...
    content: @Composable RowScope.(onTabPress: (index: Int) -> Unit) -> Unit
) {
